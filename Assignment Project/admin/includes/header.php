                ...
                <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
                    ...
                    <li class="nav-item mm-active">
                        ...
                        <ul class="sidemenu-nav-second-level">
                            <li class="nav-item mm-active">
                                <a href="dashboard-analytics.php" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="manage_author.php" class="nav-link">
                                    <span class="icon"><i class='bx bxs-shopping-bag'></i></span>
                                    <span class="menu-title">Manage Author</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="manage_collection.php" class="nav-link">
                                    <span class="icon"><i class='bx bxs-shopping-bag'></i></span>
                                    <span class="menu-title">Manage Collection</span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="manage_image.php" class="nav-link">
                                    <span class="icon"><i class='bx bxs-shopping-bag'></i></span>
                                    <span class="menu-title">Manage Image</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="manage_sale.php" class="nav-link">
                                    <span class="icon"><i class='bx bxs-shopping-bag'></i></span>
                                    <span class="menu-title">Manage sale</span>
                                </a>
                            </li>
                            <li class="nav-item">
